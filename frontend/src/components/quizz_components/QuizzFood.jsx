  ...
  return (
    <div>
      <div>
        ...
        <button type="button" name="typeOfFood" id="typeOfFood" onClick={(e) => setShowFoodQuestions(true)}>
          Carnivore
        </button>
        <button type="button" name="typeOfFood" id="typeOfFood" onClick={(e) => setCurrentQuestion(4)} >
          Végétarien
        </button>
      </div>
      {showFoodQuestions && (
        <div>
          ...
          <input type="number" name="howManyTimes" id="howManyTimes" onChange={(e) => setQuizzFoodResponse(e.target.value)} />
        </div>
      )}
    </div >
  )
